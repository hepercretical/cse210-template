...
class Program
{
    static void Main(string[] args)
    {
        ...
        Reception reception = new Reception("Reception of Christopher Luxon", "This event welcomes the Prime Miniester of New Zealand in his visit to the United States.", "12/18/2026", "6:30 PM CDT", receptionAddress, "receptions@rsvp.gov");
